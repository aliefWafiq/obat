...
<div class="main-content">
    <header class="header">
        <div class="header-left">
            ...
            <div>
                <h1 id="page-title">Edit Program</h1>
                <p style="margin: 0.3rem 0 0; color: #6b7280;">Perbarui detail program agar informasi diskon dan promo tampil lebih menarik.</p>
            </div>
        </div>
    </header>
    ...
    <section class="content-section active" style="display: flex; justify-content: center; padding: 2rem 1rem;">
        <div style="width: min(720px, 100%); background: #ffffff; border-radius: 24px; padding: 2rem; box-shadow: 0 18px 40px rgba(0,0,0,0.08);">
            ...
            <form action="/program/update/{{ $buatProgram->id }}" method="POST" enctype="multipart/form-data" class="admin-form">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="tagProgram" name="tagProgram" placeholder="Contoh: Diskon, Flash Sale" value="{{ old('tagProgram', $buatProgram->tagProgram) }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="judul" name="judul" placeholder="Masukkan judul program" value="{{ old('judul', $buatProgram->judul) }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="deskripsi" name="deskripsi" placeholder="Jelaskan detail program" style="min-height: 150px;">{{ old('deskripsi', $buatProgram->deskripsi) }}</textarea>
                </div>
