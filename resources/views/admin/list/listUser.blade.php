                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    @foreach ($users as $item)
                                        @if(auth()->user()->role === 'SuperAdmin' || $item->role !== 'SuperAdmin' && $item->role !== 'Admin')
                                            @if(auth()->user()->role === 'SuperAdmin' || auth()->user()->role === 'Admin' && $item->idKlinik === auth()->user()->idKlinik)
                                                <tr>
                                                    <td>{{ $item->username }}</td>
                                                    ...
                                                    <td>
                                                        <div class="role-edit-inline">
                                                            <span
                                                                class="role-badge {{ $item->role == 'admin' ? 'role-admin' : 'role-user' }}">{{ ucfirst($item->role) }}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('viewEditUser', $item->id) }}" class="action-btn"
                                                            title="Edit User">
