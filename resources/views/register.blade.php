...
<body>
        ...
        <div class="auth-container">
            <div class="auth-left">
                ...
                <div class="auth-left-features">
                    <div class="feature-item"><i class="fas fa-star"></i><div class="feature-item-text"><strong>Member Eksklusif</strong>Dapatkan diskon dan penawaran khusus untuk member baru</div></div>
                    <div class="feature-item"><i class="fas fa-gift"></i><div class="feature-item-text"><strong>Bonus Poin Reward</strong>Kumpulkan poin dari setiap pembelian</div></div>
                    <div class="feature-item"><i class="fas fa-lock"></i><div class="feature-item-text"><strong>Data Aman Terjamin</strong>Privasi dan keamanan data Anda adalah prioritas kami</div></div>
                </div>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="otp-input-group">
            <input type="text" id="otp" name="otp" placeholder="Masukkan kode OTP" value="{{ old('otp') }}" required>
            <button type="button" class="otp-btn" id="sendOtpBtn">Kirim OTP</button>
        </div>
