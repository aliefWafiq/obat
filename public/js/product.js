...
function renderProducts() {
    ...
    if (sortSelect) {
       ...
       cards.sort((a, b) => {
           let priceA = parseInt(a.querySelector('.card-price').textContent.replace(/\D/g, ''));
           let priceB = parseInt(b.querySelector('.card-price').textContent.replace(/\D/g, ''));
    ...
    if (showingCardTotal) {
        showingCardTotal.textContent = "Menampilkan " + visibleCards.length + " produk";
    }
}
