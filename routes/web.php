...
Route::get('/dashboard/produk/{id}/edit', [mainController::class, 'viewEditProduk'])->name('viewEditProduk')->middleware('auth');
...
Route::post('/produk/update/{id}', [actionController::class, 'updateProduk']);
Route::post('/produk/delete/{id}', [actionController::class, 'deleteProduk']);